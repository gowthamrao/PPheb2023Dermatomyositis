...
packageName <- "dermatomyositiePhenotypePhebruary2023"
...
description <- "Cohort diagnostics on Dermatomyositis."

outputFolder <-
  file.path("D:", "temp", 'phenotypePhebruary', 'dermatomyositis')

baseUrl <- "https://atlas-phenotype.ohdsi.org/WebAPI"
ROhdsiWebApi::authorizeWebApi(
  baseUrl = baseUrl,
  authMethod = "db",
  webApiUsername = keyring::key_get(service = "ATLAS-PHENOTYPE-USER"),
  webApiPassword = keyring::key_get(service = "ATLAS-PHENOTYPE-PASSWORD")
)
