...
) A on A.person_id = P.person_id  AND A.START_DATE >= DATEADD(day,-180,P.START_DATE) AND A.START_DATE <= DATEADD(day,180,P.START_DATE) ) cc 
GROUP BY cc.person_id, cc.event_id
...
WHERE C.value_as_concept_id in (9191,4126681)
